...
The goal is to create an RNN network using LSTM cells to generate text. LSTM cells are one of the best solutions to solve the gradient vanishin/exploding of vanila RNN networks.
